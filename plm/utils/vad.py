...
def get_parser():
    ...
    parser.add_argument('--target_dir', default='../data/fhs')
...
def main():
    ...
    total_dur = 0
    bad_files = []
    with open(tgt_dir / 'all_new.tsv', 'w') as f_tsv:
        print(wav_root, file=f_tsv)
        for fn in tqdm(df['audio_filepath']):
            ...
            for segment, start, end in segments:
                ...
                print('fn, start, end:', fn, start, end)  # XXX
                print(f'{fn}\t{start}\t{end}', file=f_tsv)
