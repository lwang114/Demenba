...
def get_parser():
    ...
    parser.add_argument('--out_path', default='/data/sls/scratch/limingw/workplace/speaker_anonymization/fhs_dementia_classifier/llm/exp/test_100')
...
def main():
    ...
    with open(out_label_path, 'w') as f_out,\
        ...
        open(out_res_path, 'w') as f_out_res:
        for fn in tqdm(fns):
